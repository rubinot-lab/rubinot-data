...
const openAPISpec = `{
  ...
  "paths": {
    ...
    "/v1/highscores/{world}/{category}": {"get":{"summary":"Redirect to category highscores","tags":["v1","highscores"],"parameters":[{"name":"world","in":"path","required":true,"schema":{"type":"string"}},{"name":"category","in":"path","required":true,"schema":{"type":"string","enum":["achievements","battle-pass","bounty","axe","club","charm","distance","drome","linked-tasks","experience","daily-xp","fishing","fist","loyalty","magic","prestige","shielding","sword","weekly-tasks"]}}],"responses":{"302":{"description":"Redirect"}}}},
    "/v1/highscores/{world}/{category}/{vocation}/{page}": {"get":{"summary":"Get highscores by world/category/vocation/page","tags":["v1","highscores"],"parameters":[{"name":"world","in":"path","required":true,"schema":{"type":"string"}},{"name":"category","in":"path","required":true,"schema":{"type":"string","enum":["achievements","battle-pass","bounty","axe","club","charm","distance","drome","linked-tasks","experience","daily-xp","fishing","fist","loyalty","magic","prestige","shielding","sword","weekly-tasks"]}},{"name":"vocation","in":"path","required":true,"schema":{"type":"string","enum":["all","none","knights","paladins","sorcerers","druids","monks","(all)"]}},{"name":"page","in":"path","required":true,"schema":{"type":"integer","minimum":1}}],"responses":{"200":{"description":"Highscores"}}}},
